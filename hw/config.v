...
//AXI1  DMA
`define AXI_SLV1_ADDR_BASE   32'hffff_ffff     //AXI1 base address   
`define AXI_SLV1_ADDR_LEN    32'h0000_0000     //AXI1 length
...
//APB0   PMU(电源管理)+gpio
`define APB_SLV0_ADDR_BASE   32'hbfeb_0000     //APB0 base address    
`define APB_SLV0_ADDR_LEN    32'h0000_ffff     //APB0 length
//APB1  pwm
`define APB_SLV1_ADDR_BASE   32'hbfec_0000     //APB1 base address    
`define APB_SLV1_ADDR_LEN    32'h0000_ffff     //APB1 length
//APB2  HPET
`define APB_SLV2_ADDR_BASE   32'hbfed_0000     //APB2 base address    
`define APB_SLV2_ADDR_LEN    32'h0000_ffff     //APB3 length
//APB3  confreg
`define APB_SLV3_ADDR_BASE   32'hbfea_0000     //APB3 base address    
`define APB_SLV3_ADDR_LEN    32'h0000_ffff     //APB3 length
//APB4  uart
`define APB_SLV4_ADDR_BASE   32'hbfe8_8000     //APB4 base address    
`define APB_SLV4_ADDR_LEN    32'h0000_0fff     //APB4 length
//APB5  iic
`define APB_SLV5_ADDR_BASE   32'hbfe9_0000     //APB5 base address    
`define APB_SLV5_ADDR_LEN    32'h0000_ffff     //APB5 length
//APB6  spi
`define APB_SLV6_ADDR_BASE   32'hbfe7_0000     //APB6 base address     
`define APB_SLV6_ADDR_LEN    32'h0000_ffff     //APB6 length
//APB7  LCD
`define APB_SLV7_ADDR_BASE   32'hbfee_0000     //APB7 base address   
`define APB_SLV7_ADDR_LEN    32'h0000_ffff     //APB7 length
//还没用上
//APB8  VPWM
`define APB_SLV8_ADDR_BASE   32'hffff_ffff     //APB8 base address   
`define APB_SLV8_ADDR_LEN    32'h0000_0000     //APB8 length
